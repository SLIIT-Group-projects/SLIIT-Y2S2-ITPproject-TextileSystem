                ...
                {noResult ? (
                    ...
                    <tbody>
                        {materials.map((material) => {
                            ...
                            const rowClassName = material.roll_quantity < 50 ? "low-roll-quantity" : "";
                            return (
                                <tr className={`pti-bg-light_blue ${rowClassName}`} key={material._id}>
                    ...
                    <div>
                        <table>
                            ...
                            <tr>
                                ...
                                <td className="inv-mat-anylicts-td pti-text-h3 pti-bolder text-danger">{silkTotal}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td className="inv-mat-anylicts-td pti-text-h3 pti-bolder text-danger">Lace</td>
