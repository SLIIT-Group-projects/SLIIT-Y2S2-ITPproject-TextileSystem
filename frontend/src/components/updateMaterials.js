    ...
    useEffect(() => {
        const fetchMaterialData = async () => {
            try {
                ...
                const response = await Axios.get(`http://localhost:8070/material/get/${id}`);
    ...
    return (
        <div className="container">
            ...
            <div className="d-flex justify-content-center gap-3 pb-5">
                ...
                <button className="inv-allProducts-button pti-bg-secondary_blue pti-bold pti-rounded-small border-0 text-light pti-text-p">
                    <Link className="nav-link active" to="/material">MATERIALS</Link>
                </button>
                <button className="inv-allProducts-button pti-bg-secondary_blue pti-bold pti-rounded-small border-0 text-light pti-text-p">
                    RELEASED
                </button>
            ...
            {/* Form Title */}
            <div className="text-center pti-text-h2 pti-bold pb-4">Update MATERIALS</div>
            {/* Update Form */}
            <form onSubmit={handleSubmit}>
                {/* Form Fields */}
                <div className="d-flex justify-content-center gap-3">
                    <div className="mb-3 flex-grow-1 d-flex flex-column align-items-start">
                        <label htmlFor="material_ID" className="form-label pti-text-dark pti-bold">Material ID</label>
                        <input
                            id="material_ID"
                            type="text"
                            name="material_ID"
                    ...
                    <div className="mb-3 flex-grow-1 d-flex flex-column align-items-start">
                        <label htmlFor="material_name" className="form-label pti-text-dark pti-bold">Material Name</label>
                        <input
                            id="material_name"
                            type="text"
                            name="material_name"
                ...
                <div className="d-flex justify-content-center gap-3">
                    <div className="mb-3 flex-grow-1 d-flex flex-column align-items-start">
                        <label htmlFor="roll_quantity" className="form-label pti-text-dark pti-bold">Roll Quantity</label>
                        <input
                            id="roll_quantity"
                            type="number"
                            name="roll_quantity"
                    ...
                    <div className="mb-3 flex-grow-1 d-flex flex-column align-items-start">
                        <label htmlFor="color" className="form-label pti-text-dark pti-bold">Color</label>
                        <input
                            id="color"
                            type="text"
                            name="color"
                ...
                <div className="d-flex justify-content-center gap-3 pt-4">
                    <button type="submit" className="add-product-btn pti-bold btn btn-primary pti-rounded-small">
                        Update
                    </button>
                    <button type="reset" className="add-product-btn bg-black text-light pti-bold pti-rounded-small">
                        Cancel
                    </button>
                </div>
            </form>
