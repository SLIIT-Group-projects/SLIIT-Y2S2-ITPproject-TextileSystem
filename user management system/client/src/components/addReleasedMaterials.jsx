...
function AddReleasedMaterials() {
  ...
  const sendData = async (e) => {
    ...
    try {
      ...
      await Axios.put(
        `http://localhost:3000/released_material/update/${id}`,
        updatedMaterial
      );

      // Add released materials
      await Axios.post(
        "http://localhost:3000/released_material/released/add",
        updatedMaterial
      );
      ...
      await Axios.put(
        `http://localhost:3000/material/reduce-and-add`,
        updatedQuantity
      );

      alert(
        "Released Material Added, Approval Updated, and Roll Quantity Reduced"
      );
