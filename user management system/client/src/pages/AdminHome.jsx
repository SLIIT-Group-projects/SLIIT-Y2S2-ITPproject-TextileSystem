    ...
    <div>
      ...
      <div class="d-flex flex-col">
        <div class="min-vh-100 d-flex flex-md-row flex-column ">
          <Sidebar
            class="col-md-100 text-gray-400 w-full"
              ...
              <Sidebar.ItemGroup>
                <Link to="/profile">
                  <Sidebar.Item
                    ...
                    icon={HiUser}
                    labelColor="dark"
                    class="btn btn-outline-primary border-2 border-primary "
          ...
          <div className="row">
            <div className="col-md-10 mx-auto p-3">
              <div class="d-flex flex-wrap gap-4 justify-content-center">
                <div
                  class="d-flex flex-column p-3   gap-3 col-md-3 col-12 rounded-md shadow-md"
                  style={{
                ...
                >
                  <div class="d-flex justify-content-between">
                    <div className="">
                      <h3
                        class="text-gray-500 text-uppercase"
                    ...
                    <HiOutlineUserGroup
                      class="bg-teal text-dark rounded-circle display-1 p-3 shadow-lg"
                ...
                <div
                  class="d-flex flex-column p-3  gap-4 col-md-3 col-12 rounded-md shadow-md"
                  style={{
                    backgroundColor: "lightblue",
                    boxShadow: "0 0 10px 0 rgba(0, 0, 0, 0.3)",
                  }}
              ...
              <div class="d-flex flex-wrap gap-4 py-3 mx-auto justify-content-center">
                <div
                  class="d-flex flex-column w-96  shadow-md p-2 rounded-md "
                ...
                >
                  <div class="d-flex justify-content-between p-1 font-weight-bold text-small">
                    ...
                    <a
                      ...
                      style={{
                        linearGradient:
                          "linear-gradient(90deg, blue, 0%, purple 100%)",
                      }}
                    >
                      See all
                    </a>
                ...
                <div
                  class="d-flex flex-column w-96 md:w-auto shadow-md p-2 rounded-md "
                  style={{ backgroundColor: "lightgray" }}
                >
